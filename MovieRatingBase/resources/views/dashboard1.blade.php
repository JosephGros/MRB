        ...
        document.getElementById('contentToUpdate').innerHTML = `
            <div class="flex pt-2 md:flex md:justify-center md:items-center">
                ...
                <div class="basis-1/2 md:basis-none md:w-1/2">
                    <iframe class="h-[185px] w-auto rounded-lg border-solid border-2 border-sky-600 ml-2 md:h-[500px] md:w-auto md:border-4 md:ml-6" src="{{$randomItem->trailer}}" alt="{{$randomItem->name}}"></iframe>
                </div>
